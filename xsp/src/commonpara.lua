...
{Name = "8场景1",
  ...
  Run = (function()
  screen.keep()
  local xa,ya = findMultiColorInRegionFuzzy(0xffebeb,"14|0|0x441b1b,27|0|0xffe8e8,41|0|0x441b1b,54|0|0xffe8e8", 95, 0,300,1919,800)--三个点对话框
  local xb,yb = findMultiColorInRegionFuzzy(0xdbd6c4,"3|0|0x22180f,2|2|0x675f53", 90,1330,810,1340,812)--点跳过
  local xc, yc = findMultiColorInRegionFuzzy(0xeac819,"19|0|0x3f363a,44|0|0xb5b7bb,25|14|0x433840", 95,0,200,1919,1000)--点大眼睛
  local xd, yd= findMultiColorInRegionFuzzy(0x2f250a,"12|0|0xffefdd,12|3|0xfeeedb,2|3|0x3a2e0a", 95, 0,200,1919,1000)--点问号
  local xe, ye = findMultiColorInRegionFuzzy(0x414a7b,"16|3|0xd5d5f6,12|10|0xfcfdfe,5|11|0xf0f0fe", 95, 0,300,1919,800)--点击战斗
  screen.unkeep()
